 ...
 */
const allowedOrigins = ['https://purepressure.vercel.app', 'https://www.google.com', 'https://purepressurehawaii.com', 'https://wwww.purepressurehawaii.com', 'http://localhost:3000']
const corsOptions = {
